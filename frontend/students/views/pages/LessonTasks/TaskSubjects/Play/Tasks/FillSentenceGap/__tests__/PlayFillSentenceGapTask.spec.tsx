...
import { mockTask } from './__mocks__/PlayFillSentenceGapTaskMock';
import PlayFillSentenceGapTask from '../PlayFillSentenceGapTask';
...
async function checkItemWords(item: IFillSentenceGapItem) {
...
describe('<PlayFillSentenceGapTask />', () => {
  beforeEach(() => {
    render(<PlayFillSentenceGapTask isCompleting={false} task={mockTask} />);
  });
