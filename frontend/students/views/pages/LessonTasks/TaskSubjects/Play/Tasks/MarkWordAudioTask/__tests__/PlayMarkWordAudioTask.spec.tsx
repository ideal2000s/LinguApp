...
import { mockTask } from './__mocks__/PlayMarkWordAudioTaskMock';
import PlayMarkWordAudioTask from '../PlayMarkWordAudioTask';
...
async function checkItemWords(item: IMarkWordAudioItem) {
...
describe('<PlayMarkWordAudioTask />', () => {
  beforeEach(() => {
    render(<PlayMarkWordAudioTask isCompleting={false} task={mockTask} />);
  });
