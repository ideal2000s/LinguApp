...
module School
  module HubSpot
    module Cases
      RSpec.describe CreateContact, type: :service do
        subject(:result) do
        ...
        before do
          ...
          stub_request(:post, 'https://api.hubapi.com/crm/v3/objects/contacts?hapikey=hubspot-api-key')
            .with(
        ...
        describe '#call' do
          it 'assigns hubspotid to user' do
            expect { result }.to change(user, :hubspotid).to(response_stub[:id])
          end
        end
      end
    end
