...
module Tasks
  class Text < ::Task
    ...
    def convert_type
      update(type: 'Tasks::TranslatableText')
      items.update_all(type: 'TaskItems::TranslatableText') # rubocop:disable Rails/SkipsModelValidations
    end
  end
end
